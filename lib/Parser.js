...
class Parser extends Tapable {
	...
	parseAsModuleOrScript(source) {
		try {
			...
			const moduleAstOptions = Object.assign({}, PARSE_OPTIONS_MODULE, { onComment: moduleComments });
			...
			try {
				...
				const scriptAstOptions = Object.assign({}, PARSE_OPTIONS_SCRIPT, { onComment: scriptComments });
