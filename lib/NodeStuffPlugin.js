...
NodeStuffPlugin.prototype.apply = function(compiler) {
	...
	compiler.plugin("compilation", function(compilation, params) {
		...
		params.normalModuleFactory.plugin("parser", function(parser, parserOptions) {
			...
			parser.evaluateIdentifierWalker.plugin("__filename", function(expr) {
			...
			parser.evaluateIdentifierWalker.plugin("__dirname", function(expr) {
				if(!parser.state.module) return;
			...
			parser.evaluateIdentifierWalker.plugin("module.hot", ParserHelpers.evaluateToBoolean(false));
