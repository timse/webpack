...
NodeStuffPlugin.prototype.apply = function(compiler) {
	...
	compiler.plugin("compilation", function(compilation, params) {
		...
		params.normalModuleFactory.plugin("parser", function(parser, parserOptions) {
			...
			parser.evaluateIdentifierPlugin.plugin("__filename", function(expr) {
			...
			parser.evaluateIdentifierPlugin.plugin("__dirname", function(expr) {
				if(!parser.state.module) return;
			...
			parser.evaluateIdentifierPlugin.plugin("module.hot", ParserHelpers.evaluateToBoolean(false));
