...
HotModuleReplacementPlugin.prototype.apply = function(compiler) {
	...
	compiler.plugin("compilation", function(compilation, params) {
		...
		params.normalModuleFactory.plugin("parser", function(parser, parserOptions) {
			...
			parser.evaluateTypeOfWalker.plugin("evaluate typeof __webpack_hash__", ParserHelpers.evaluateToString("string"));
			parser.evaluateIdentifierWalker.plugin("module.hot", function(expr) {
