...
HotModuleReplacementPlugin.prototype.apply = function(compiler) {
	...
	compiler.plugin("compilation", function(compilation, params) {
		...
		params.normalModuleFactory.plugin("parser", function(parser, parserOptions) {
			...
			parser.evaluateTypeOfPlugin.plugin("evaluate typeof __webpack_hash__", ParserHelpers.evaluateToString("string"));
			parser.evaluateIdentifierPlugin.plugin("module.hot", function(expr) {
				return ParserHelpers.evaluateToBoolean(!!parser.state.compilation.hotUpdateChunkTemplate)(expr);
			});
