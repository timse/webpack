				...
				case 2:
					{
						...
						if(fnExpression) {
							parser.traverseNodesInCurrentScope(fnExpression.expressions);
						}
						...
						try {
							...
							if(fnExpression) {
								parser.traverseNodeInCurrentScope(fnExpression.fn.body);
							}
							old.addBlock(dep);
						} finally {
						...
						if(!fnExpression) {
							parser.traverseNodeInCurrentScope(fnExpressionArg);
						}
						return true;
					}
			}
