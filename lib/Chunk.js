...
class Chunk {
	...
	constructor(name, module, loc) {
		...
		this.entrypoints = [];
		// do not allow sort caching, as ids may not be set on first sort
		this._chunks = new SortableSet(undefined, sortById, true);
		// do not allow sort caching, as ids may not be set on first sort
		this._parents = new SortableSet(undefined, sortById, true);
...
Object.defineProperty(Chunk.prototype, "blocks", {
	...
	set() {
		throw new Error("Readonly. Use Chunk.addBlock/removeBlock/getBlocks to access/modify blocks.");
	}
});
